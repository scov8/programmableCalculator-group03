...
public class Operations {
    ...
    public static ComplexNumber sum(ComplexNumber leftOperand, ComplexNumber rightOperand) {
        return new ComplexNumber(
            leftOperand.getReal() + rightOperand.getReal(),
            leftOperand.getImaginary() + rightOperand.getImaginary()
        );
    }
    ...
    public static ComplexNumber multiplication(ComplexNumber leftOperand, ComplexNumber rightOperand) {
        return new ComplexNumber(
            leftOperand.getReal() * rightOperand.getReal() - leftOperand.getImaginary() * rightOperand.getImaginary(),
            leftOperand.getImaginary() * rightOperand.getReal() + leftOperand.getReal() * rightOperand.getImaginary()
        );
    }
    ...
    public static ComplexNumber division(ComplexNumber leftOperand, ComplexNumber rightOperand) throws IndeterminateFormException {
        ...
        double numeratorA = leftOperand.getReal() * rightOperand.getReal() +
                            leftOperand.getImaginary() * rightOperand.getImaginary();
        double numeratorB = leftOperand.getImaginary() * rightOperand.getReal() -
                            leftOperand.getReal() * rightOperand.getImaginary();
